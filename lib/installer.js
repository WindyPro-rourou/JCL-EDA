...
/**
 * Locate an existing `ws` package on this machine (the DSH host ships it) so
 * we can vendor it WITHOUT npm — this machine has PowerShell ExecutionPolicy
 * blocking `npm.ps1`, and offline copy is faster and never touches the
 * registry.
 */
